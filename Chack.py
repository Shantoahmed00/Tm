#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Shanto_Ahmed
...
\033[0;96m*@@@***@@m                                  m@@                                        @@@**@@**@@@                  
\033[0;96m @@   *@@m                                  @@                                        @*   @@   *@                  
\033[0;96m  @@   m@@    m@@*@@m *@@@@@@@@m   m@*@@@@@  @@m@@@@m   m@*@@m   m@*@@m   @***@@@           @@     *@@@@@@@@m@@@@@m  
\033[0;96m  !@@@@@@    @@*   *@@  @@    @@  m@@  @@    @@    *@@ @@   @@  @@   @@   *  @@@            !@       @@    @@    @@  
\033[0;96m !@  @@m    @@     @@  @!    @@  *!!@@@*    !@     @@  m@@@!@   m@@@!@     @@!             !@       !@    @@    @@  
\033[0;96m  !@   *!@   @@     !@  @!    !@  @!         !!!   m@! @!   !@  @!   !@    !@@              !@       !@    !@    @@  
\033[0;96m  !@  ! !!   !@     !!  !!    !!  *!!!!!*    !!     !!  !!!!:!   !!!!:!    !@!              !@       !!    !!    !!  
...
\033[1;91m (__| |______________________________________________________________________________________________________| |__) 
\033[1;91m(__| |_____________________________________________________________________________________________________| |__)
                                     C.E.O : FAYSAL BILLAL MIR | C.O " C.E.O EMON HASAN
                                      SENIOR ADMID: MUKTER HOSSAIN | : MAMUN AHMED |  ARIYAN AHMED 
                                      ADMIN : TUHIN AHMED |  SALMAN AHMED 
                                      AHMED SAIDUL KHAN | SABBIR AHMED 
                                     MD : ASHRAFUL HOQUE | MD: AKASH MATUBBER | | SAHANTO AHMED,  | |   
\033[1;91m ( __| |_____________________________________________________________________________________________________| |__)
\033[1;91m(__|_|____________________________________________________________________________________________________|_|__)
 """
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Shanto_Ahmed
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://www.facebook.com/groups/435431549969296/')
    else:
...
def login1():
	...
	try:
		...
		print('\033[1;97m\x1b[1;93m━━━━Login Your Facebook Accunt━━━━\x1b[1;97m' )
		print('	' )
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:SHANTO_AHMED
	print logo
	...
	print "\033[1;97m[1]\x1b[1;92mStart Cloning With RONGBAAZ_TM Tools"
	print "\033[1;97m[2]\x1b[1;92mContact Our official Fb Page"
	print "\033[1;97m[3]\x1b[1;92mJOIN Our group "
	print "\033[1;97m[4]\x1b[1;92mContact  On Fb"
	print "\033[1;97m[5]\x1b[1;96mWellcome To Rongbaaz family " 
	print "\033[1;97m[0]\033[1;96mExit            "
	pilih()
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://gitub.com/shantoerror')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://github.com/shantoerror')
                menu()
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m\033[1;91mRongbaaz Tm\033[1;95m"
		print logo
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;93m━━━━Start Cloning in to Rongbaaz Tm━━━━\033[1;93m"+o),;sys.stdout.flush();time.sleep(0.05)
	print "\n\033[1;92mNOTE:\x1b[1;93m [If You Want to Stop Process Press CTRL+Z]"
	print "\033[1;95m━━━━✙━━━━\033[1;91mCp accunt open 7 days befor\033[1;95m━━━━✙━━━━"
...
#Dev:Shanto Ahmed
        print "\033[1;95m\033[1;91mRongbaaz Tm\033[1;95m"
	print '\033[1;94mCloining accunt with Rongbaaz Tm '
	print"\033[1;94mTotal\033[1;92mOK/\x1b[1;91mCP \033[1;91m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033[1;91m"+str(len(cekpoint))
	print "\033[1;95mRongbaaz Tm\033[1;91mMAAN_KHAN404\033[1;95m"
	print """
             
\033[1;96m🎇⚏⚏⚏MAAN⚏⚏⚏🎇 ✔️Update Comming Soon✔️
"""
	print "\033[1;95m━━━━✙━━━━\033[1;91mThanks to use our tool\033[1;95m━━━━✙━━━━"
